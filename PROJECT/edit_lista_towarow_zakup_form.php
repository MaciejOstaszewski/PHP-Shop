...
<body>
  ...
  <header>
    <a href="services/logout.php"><div class="rejestracja">WYLOGUJ SIĘ</div></a>
      EDYCJA TOWARU ZAMÓWIONEGO DO SKLEPU
  ...
  <section>
    ...
    $id_zamowienia = $_GET['id_zamowienia'];
     ?>
    <form action="services/edit_lista_zakup.php?id=<?php echo $id."&id_zamowienia=".$id_zamowienia."&iloscS=".$quantityOld."&ware=".$towar; ?>" method="post">
      Podaj ilość:<br>
