...
<body>
    ...
    <a href="pracownicy.php" class="turnBack"><i class="icon-left"></i></a>
  <header>
  ...
  <section>
    ...
    $pensja = $_GET['pensja'];
     ?>
    <form action="services/edit_pracownik.php?id=<?php echo $id; ?>" method="post">
      Podaj imie:<br>
      ...
      Podaj penjsę:<br>
      <input type="text" name="money" value="<?php echo $pensja; ?>" required oninvalid="this.setCustomValidity('Pole wymagane')" oninput="setCustomValidity('')"><br>
